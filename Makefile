...
PROJECT_REPO ?= github.com/allenkallz/$(PROJECT_NAME)
ORG_NAME ?= allenkallz
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-snowflake_$(TERRAFORM_PROVIDER_VERSION)
...
XPKG_REG_ORGS ?= ghcr.io/allenkallz
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= ghcr.io/allenkallz
XPKGS = $(PROJECT_NAME)
